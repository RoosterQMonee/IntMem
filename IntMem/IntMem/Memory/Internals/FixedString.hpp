...
#define INTMEM_DEFINE_FIXED_STRING(name, type)                                                          \
    template<size_t N>                                                                                      \
    ...
    INTMEM_DEFINE_FIXED_STRING(fixed_string, char)
    INTMEM_DEFINE_FIXED_STRING(wfixed_string, wchar_t)
    INTMEM_DEFINE_FIXED_STRING(u8fixed_string, char8_t)
    INTMEM_DEFINE_FIXED_STRING(u16fixed_string, char16_t)
    INTMEM_DEFINE_FIXED_STRING(u32fixed_string, char32_t)

#undef INTMEM_DEFINE_FIXED_STRING
}